const MOVE_DATA = {
    ...
    'thunder wave': { type: 'Eléctrico', pp: 20, power: 0, accuracy: 90 },
    ...
    'smokescreen': { type: 'Normal', pp: 20, power: 0, accuracy: 100 },
    'scratch': { type: 'Normal', pp: 35, power: 40, accuracy: 100 },
    'leer': { type: 'Normal', pp: 30, power: 0, accuracy: 100 },
    'hypnosis': { type: 'Psíquico', pp: 20, power: 0, accuracy: 60 },
